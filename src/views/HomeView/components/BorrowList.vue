  ...
  <div class="DepositList">
    <div class="data-list">
      ...
      <div class="list-item">
        ...
        <div class="col usdt-apr">
          {{chainRate1[1]?dealNum(chainRate1[1].borrow_apy * 100):0}}%

        </div>
        <div class="col eth-apr">
          {{chainRate1[0]?dealNum(chainRate1[0].borrow_apy * 100):0}}%

        </div>
        <div class="col borrow">
          <div class="primary-btn-sha"  @click="$router.push('/lend')">
            Borrow
          </div>
        </div>
      </div>
      <div class="list-item">
        ...
        <div class="col usdt-apr">
          {{chainRate2[1]?dealNum(chainRate2[1].borrow_apy*100):0}}%
        </div>
        <div class="col eth-apr">
          {{chainRate2[0]?dealNum(chainRate2[0].borrow_apy * 100):0}}%
        </div>
        <div class="col borrow-op">
          <div class="primary-btn-sha"  @click="$router.push('/lend')">
            Borrow
    ...
    <div class="data-list-m">
      <div class="data-item-m">
        ...
        <div class="data-box">
          <div class="primary-btn" @click="$router.push('/lend')">
            Borrow
          </div>
        </div>
      ...
      <div class="data-item-m">
        ...
        <div class="data-box">
          ...
          <div class="value-box g-c">
            {{chainRate2[1]?dealNum(chainRate1[1].borrow_apy * 100):0}}%
          </div>
        </div>
        <div class="data-box">
          <div class="name">
          ...
          <div class="value-box b-c">
            {{chainRate2[0]?dealNum(chainRate1[0].borrow_apy * 100):0}}%
          </div>
        </div>
        <div class="data-box">
          <div class="primary-btn" @click="$router.push('/lend')">
